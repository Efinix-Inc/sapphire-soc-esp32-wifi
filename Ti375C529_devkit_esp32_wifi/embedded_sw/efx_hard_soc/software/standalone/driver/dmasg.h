...
#define DMASG_DESCRIPTOR_STATUS_COMPLETED                       BIT_31
    ...
    // Allow to start a channel using a linked list streamed not from memory, but from the dedicated hardware channel.
    // Be sure the channel was enabled to support linked list mode.
    // channel is the DMA channel ID to use.
